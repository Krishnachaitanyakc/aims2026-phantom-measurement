...
Reproduction artifact for the accepted AIMS 2026 paper, “Phantom Measurement Artifacts in Multi-Step LLM Evaluation,” by Krishna Chaitanya Balusu, Independent Researcher.
...
Author code retains its [MIT license](artifact/LICENSE). GSM8K retains [OpenAI's MIT notice](artifact/licenses/GSM8K-MIT.txt). Model outputs are not relicensed by those notices; see [license provenance](artifact/licenses/README.md).
